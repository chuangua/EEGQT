...
from mnelab.dialogs.lisha_ERP import ERPDialog
from mnelab.dialogs.lisha_pickcom import PickComponents
from mnelab.dialogs.lisha_resampling import SampleDialog